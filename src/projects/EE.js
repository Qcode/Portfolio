export default {
  ...
  description: `
  During high school I took an enrichment program known as the International Baccalaureate Diploma Program (IBDP). All IB students are required to write a 4,000 word essay, known as the Extended Essay, on a subject of their choosing.
  Each student's Extended Essay should contain significant research components.
